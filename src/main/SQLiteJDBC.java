...
public class SQLiteJDBC {
	...
	public static HashMap<ExtendedFixture, Float> selectScores(ArrayList<ExtendedFixture> all,
	...
	public static void storeFinals(ArrayList<FinalEntry> finals, int year, String competition,
			String description) {
		synchronized(this){
		Connection c = null;
		Statement stmt = null;
	...
	public static void storePlayerFixtures(ArrayList<PlayerFixture> finals, int year, String competition) {
		synchronized(this){
		Connection c = null;
		Statement stmt = null;
		try {
	...
	public static ArrayList<PlayerFixture> selectPlayerFixtures(String competition, int year)
	...
	public static ArrayList<FinalEntry> selectFinals(String competition, int year, String description)
			throws InterruptedException {
	...
	public static ArrayList<HTEntry> selectHTData(String competition, int year, String description)
			throws InterruptedException {
	...
	public static void storeHTData(ArrayList<HTEntry> halftimeData, int year, String competition,
			String description) {
		synchronized(this){
		Connection c = null;
		Statement stmt = null;
	...
	public static void storeAllData(ArrayList<AllEntry> halftimeData, int year, String competition,
			String description) {
		synchronized(this){
		Connection c = null;
		Statement stmt = null;
